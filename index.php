            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                        <div class="service shadow" id="box">
                            <div class="icon">
                                <img src="/img/run.jpg" alt="">
                            </div>
                            <h4>Běh</h4>
                                <p>Služby pro rekreační i výkonnostní běžce</p>
                            <button id="run-button" class="btn-outline-link"> 
                                Zjistit více..
                            </button>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                        <div class="service shadow">
                            ...
                            <h4>Cyklistika & Triatlon</h4>
                                <p>Funkční vyšetření, tréninkové plány...</p>
                            <button id="bike-button" class="btn-outline-link"> 
                                    Zjistit více..
                                </button>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                        <div class="service shadow">
                            ...
                            <h4>Pohyb & cvičení & fitness</h4>
                                <p>Individuální cvičení s trenérem...</p>
                                <button id="yoga-button" class="btn-outline-link"> 
                                    Zjistit více..
                                </button>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                        <div class="service shadow">
                            <div class="icon">
                                <img src="/img/fyzio.jpg" alt="">
                            </div>
                            <h4>Fyzioterapie & Léčba pohybem</h4>
                                <p>Bolí Vás záda, krční páteř....?</p>
                                <button id="fyzio-button" class="btn-outline-link"> 
                                    Zjistit více..
                                </button>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                        <div class="service shadow">
                            <div class="icon">
                                <img src="/img/vyziva.jpg" alt="">
                            </div>
                            <h4>Výživové poradenství</h4>
                                <p>Určení tělesné skladby, individuální výživová strategie</p>
                                <button id="food-button" class="btn-outline-link"> 
                                    Zjistit více..
                                </button>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                        <div class="service shadow">
                            ...
                            <h4>Poradenství v oblastni životního stylu</h4>
                                <p>Životní styl....</p>
                                <button id="life-button" class="btn-outline-link"> 
                                    Zjistit více..
                                </button>
                        </div>
                    </div>
